...
class FlockDriver(object):
    ...
    def __init__(self):
        ...
        rospy.Subscriber(self.publish_prefix+'move_up', Int32, self.move_up_callback)
        rospy.Subscriber(self.publish_prefix+'move_down', Int32, self.move_down_callback)
        rospy.Subscriber(self.publish_prefix+'move_left', Int32, self.move_left_callback)
        rospy.Subscriber(self.publish_prefix+'move_right', Int32, self.move_right_callback)
        rospy.Subscriber(self.publish_prefix+'rotate_cw', Int32, self.move_rotateclockwise_callback)
        rospy.Subscriber(self.publish_prefix+'rotate_ccw', Int32, self.move_rotatecounterclockwise_callback)
        rospy.Subscriber(self.publish_prefix+'move_forward', Int32, self.move_forward_callback)
    ...
    def move_right_callback(self,msg):
        self._drone.move_right(msg.data)

    
    def move_left_callback(self,msg):
        self._drone.move_left(msg.data)
    
    def move_down_callback(self,msg):
        self._drone.move_down(msg.data)
    
    def move_forward_callback(self,msg):
        self._drone.move_forward(msg.data)

    def move_rotateclockwise_callback(self,msg):
        self._drone.rotate_cw(msg.data)

    def move_rotatecounterclockwise_callback(self,msg):
        self._drone.rotate_ccw(msg.data)
